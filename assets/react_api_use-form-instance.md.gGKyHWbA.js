import{_ as s,c as n,o as a,V as o}from"./chunks/framework.kfKM6DKc.js";const u=JSON.parse('{"title":"useFormInstance()","description":"","frontmatter":{},"headers":[],"relativePath":"react/api/use-form-instance.md","filePath":"react/api/use-form-instance.md"}'),l={name:"react/api/use-form-instance.md"},e=o(`<h1 id="useforminstance" tabindex="-1"><code>useFormInstance()</code> <a class="header-anchor" href="#useforminstance" aria-label="Permalink to &quot;\`useFormInstance()\`&quot;">​</a></h1><div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki min-dark vp-code"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#B392F0;"> {Form</span><span style="color:#BBBBBB;">,</span><span style="color:#B392F0;"> useFormInstance} </span><span style="color:#F97583;">from</span><span style="color:#FFAB70;"> &#39;@formulier/react&#39;</span></span>
